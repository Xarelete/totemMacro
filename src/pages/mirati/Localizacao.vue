...
<script setup>
import { ref } from 'vue'
// Imagens públicas do Mirati (deixe seus arquivos em public/mirati/localizacao)
const mapa = '/mirati/localizacao/localizacao1.png'
const plantaTorres = '/mirati/localizacao/planta-implantacao-torres.jpeg'
// fundo sólido (#002262)
